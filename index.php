...
<div style="">
	...
	<center><button class="info" onclick="window.open('https://bit.ly/vireninstagram');"><i style="float: left;background-color: #90d5ec;
background-image: linear-gradient(315deg, #90d5ec 0%, #fc575e 74%);" class="fa fa-instagram"></i>&nbsp;Check My Instagram</button></center><br>
