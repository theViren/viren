...
<body itemscope itemtype="http://schema.org/Person"><header class=hidden-print>
    ...
    <p><button type=button class="btn btn-primary" onclick="window.open('https://drive.google.com/uc?export=download&id=1_bdurHlhThemFm3OFwFV8z-DeKgGXSD_');"><i class="fa fa-print" aria-hidden=true></i> Download Résumé</button></p>
      ...
      <section class="section__wide" id=contact><div class="powr-form-builder" id="7544cfc9_1613658260"></div><script src="https://www.powr.io/powr.js?platform=html"></script>
</section></div></div>
    <a href="whatsapp://send?text=&#128071See My Portfolio%20&#128071%20http://theviren.herokuapp.com/about.php" data-action="share/whatsapp/share" class="float" target="_blank"><i class="fa fa-whatsapp my-float"></i>
</a>
  </main>
